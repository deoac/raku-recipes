...
#         FILE: <.raku>
#
#  DESCRIPTION: Raku Recipes, Chapter 2.4
#               Read and Process Binary Files
#
#        NOTES:
#       AUTHOR: <Shimon Bollinger>  (<deoac.bollinger@gmail.com>)
#      VERSION: 0.0.1
#     REVISION: Last modified: Wed 02 Nov 2022 05:22 PM EDT
#===============================================================================
use v6.d;
...
my $index = 0;
until $image[$index] == 255 and
        $image[$index+1] == any 0xc0, 0xc2 {
    $index++;
    last if $index > $image.elems;
}

if $index < $image.elems {
    say "Height => ", $image[$index+5]*256 + $image[$index+6], " pixels";
    say "Width  => ", $image[$index+7]*256 + $image[$index+8], " pixels";
} else {
    say "Are you sure this is a healthy JPG file?
         Cause I couldn't find its meta-data";
}
