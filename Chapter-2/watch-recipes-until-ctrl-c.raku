...
#         FILE: <.raku>
#
#  DESCRIPTION: Raku Recipes, Chapter 2.5b
#
#        NOTES:
#       AUTHOR: <Shimon Bollinger>  (<deoac.bollinger@gmail.com>)
#      VERSION: 0.0.1
#     REVISION: Last modified: Wed 02 Nov 2022 09:57:06 PM EDT
#===============================================================================
use v6.d;
...
my Str $dir = @*ARGS[0] // '../recipes';

my $dir-wath-supply = $dir.IO.watch;
my $ctrl-c = Promise.new;

$dir-wath-supply.tap: -> $change {
    given $change.event {
        say $change.event;
         when FileChanged { say "{$change.path} has changed." };
         when FileRenamed { say "{$change.path} has been renamed, moved, " ~
                                  "deleted or created." };
         default { say $change.event };
    }
} # $dir-wath-supply -> $change
